...
public class WaveManager {
    ...
    public WaveManager(List<Position> pathing, List<Bloon> bloons) {
        ...
        queue = new ArrayDeque<BloonSpawn>();
        queue.add(new BloonSpawn(40, new RaimbowBloon(pathing), 30));
        queue.add(new BloonSpawn(45, new CeramicBloon(pathing), 20));
        queue.add(new BloonSpawn(40, new RaimbowBloon(pathing), 30));
        ...
        queue.add(new BloonSpawn(20, new BlackBloon(pathing), 200));
        wave = new Wave("Wave 48 / 65", queue);
        waves.add(wave);

        queue = new ArrayDeque<BloonSpawn>();
        queue.add(new BloonSpawn(4, new GreenBloon(pathing), 343));
